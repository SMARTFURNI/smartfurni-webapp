...
3. Kiểm tra ảnh trực tiếp trên CRM.
4. `apply` đổi các URL đã biết trong database và tách ảnh base64 của Catalogue,
   chữ ký hợp đồng thành object riêng.
5. Giữ bản cũ tối thiểu một chu kỳ backup trước khi cân nhắc dọn dẹp.
