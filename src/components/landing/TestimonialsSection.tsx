...
const TESTIMONIALS = [
  {
    ...
    city: "TP. Hồ Chí Minh",
    rating: 5,
    text: "Sau 3 tháng dùng SmartFurni Pro, tôi thích nhất là đổi được góc nằm khi đọc sách và nghỉ ngơi. Cảm giác thư giãn hơn sau ngày làm việc dài.",
  ...
  },
  {
    ...
    city: "Hà Nội",
    rating: 5,
    text: "Tích hợp Apple HomeKit hoạt động mượt. Tôi có thể điều chỉnh giường bằng giọng nói hoặc điện thoại, rất tiện vào buổi tối.",
  ...
  },
  {
    id: 3,
    name: "Lê Thị Thu",
    role: "Quản lý showroom nệm",
    city: "Đà Nẵng",
    rating: 5,
    text: "Khách đến showroom dễ hiểu sản phẩm hơn khi được thử nâng đầu, nâng chân và Zero Gravity trực tiếp. Remote rõ nút, người lớn tuổi thao tác nhanh.",
  ...
  },
  {
    ...
    city: "Cần Thơ",
    rating: 5,
    text: "Ban đầu tôi lo ngại về giá, nhưng sau khi dùng thử 30 ngày thì thấy đáng tiền. Tư thế nằm thoải mái hơn và phòng ngủ cũng gọn gàng hơn.",
    product: "SmartFurni Basic",
    initials: "VL",
    color: "#8E6B6B",
  },
      ...
      <div style={{ maxWidth: "1200px" }} className="mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t, i) => (
            <ScrollReveal key={t.id} variant="fadeUp" delay={150 + i * 80}>
              <div
                style={{ backgroundColor: colors.surface, borderColor: colors.border }}
                className="rounded-2xl border p-5 flex flex-col gap-4 hover:border-[#C9A84C]/30 transition-colors duration-200 h-full"
              >
                {/* Stars */}
                <div className="flex gap-0.5">
                  {[1, 2, 3, 4, 5].map((s) => (
