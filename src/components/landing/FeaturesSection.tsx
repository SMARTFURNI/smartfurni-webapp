          ...
          <ScrollReveal variant="fadeUp" delay={0}>
            <div className="text-center mb-10 sm:mb-14">
              ...
              <p style={{ fontSize: subtitle ? `${subtitle.fontSize}px` : "15px", color: subtitle?.color ?? textColor, fontWeight: subtitle ? FW_MAP[subtitle.fontWeight] : "400", opacity: 0.5 }} className="max-w-xl mx-auto">
                {subtitle?.text ?? "Tập trung vào những trải nghiệm khách dùng hằng ngày: đổi tư thế, điều khiển nhanh và yên tâm khi lắp đặt."}
              </p>
            </div>
          </ScrollReveal>
        ...
        <div>
          <ScrollReveal variant="fadeUp" delay={0}>
            <div className="text-center mb-10">
              ...
              <p className="text-sm" style={{ color: `${textColor}45` }}>Các thao tác thường dùng được gom lại để bạn xem nhanh trên mọi thiết bị.</p>
            </div>
          </ScrollReveal>
