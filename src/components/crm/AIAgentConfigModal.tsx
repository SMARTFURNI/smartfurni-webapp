  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50" style={{ background: "rgba(0,0,0,0.75)", backdropFilter: "blur(8px)" }}>
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        {/* Tabs */}
        <div className="flex border-b bg-[rgba(255,255,255,0.04)]">
        ...
        {/* Footer */}
        <div className="flex gap-3 p-6 border-t bg-[rgba(255,255,255,0.04)]">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-[rgba(255,255,255,0.08)] transition-all"
          >
            Hủy
          </button>
          <button
