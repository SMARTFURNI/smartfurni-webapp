...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Hotline Inbound", href: "/crm/hotline-inbound", icon: PhoneIncoming, permissionKey: "call_logs_view" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Facebook Inbox", href: "/crm/facebook-inbox", icon: Facebook, permissionKey: "content_marketing_view" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Analytics", href: "/crm/facebook-group-marketing/reports", icon: BarChart3, permissionKey: "facebook_group_reports" },
      { label: "AI & quy tắc", href: "/crm/facebook-group-marketing/settings", icon: Settings, permissionKey: "facebook_group_settings" },
    ],
  },
  {
