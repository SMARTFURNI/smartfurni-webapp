      ...
      <div style={{ position: "fixed", bottom: 140, right: 20, zIndex: 850, display: "flex", flexDirection: "column", gap: 14, alignItems: "center" }}>
        ...
        <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <a href="https://zalo.me/0918326552" target="_blank" rel="noopener noreferrer" title="Chat Zalo"
            style={{ position: "relative", zIndex: 2, width: 54, height: 54, borderRadius: "50%", background: "transparent", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "none", textDecoration: "none", transition: "transform 0.2s" }}
            onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1.1)"}
            onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)"}>
            <svg width="54" height="54" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
