...
export const defaultTheme: SiteTheme = {
  ...
  homepageSections: {
    ...
    problems: {
      ...
      subtitle: { text: "SmartFurni bắt đầu từ các tình huống rất đời thường: nằm đọc sách bị mỏi cổ, người lớn tuổi khó ngồi dậy, căn hộ nhỏ cần nội thất đa năng.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "🛏️", title: "Đau lưng, mỏi cổ khi nằm lâu", desc: "Không cần kê nhiều gối; giường nâng đầu và chân giúp cơ thể ở tư thế dễ chịu hơn." },
        { icon: "🧓", title: "Người lớn tuổi khó ngồi dậy", desc: "Tư thế nâng đầu hỗ trợ chuyển từ nằm sang ngồi thuận tiện hơn trong sinh hoạt hằng ngày." },
        { icon: "🌙", title: "Ngủ không thoải mái khi nằm phẳng", desc: "Các preset giúp cá nhân hóa tư thế nghỉ ngơi theo từng nhu cầu." },
        { icon: "🏙️", title: "Không gian sống cần đa năng", desc: "Sofa giường và giường thông minh giúp căn hộ nhỏ linh hoạt hơn." },
      ],
    },
    solutions: {
      ...
      subtitle: { text: "Giúp khách hàng chọn theo người dùng, không gian sống và mục tiêu sử dụng trước khi xem từng mẫu sản phẩm.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "👨‍👩‍👧", title: "Gia đình có người lớn tuổi", desc: "Ưu tiên remote đơn giản, nâng đầu/chân êm và chính sách bảo hành rõ ràng." },
        { icon: "💼", title: "Người làm việc nhiều", desc: "Gợi ý mẫu có Zero Gravity, massage và preset đọc sách/xem TV." },
        { icon: "🏢", title: "Căn hộ nhỏ", desc: "Ưu tiên sofa giường hoặc thiết kế đa năng, tối ưu diện tích." },
        { icon: "📱", title: "Khách hàng yêu công nghệ", desc: "Tập trung vào app, preset, Bluetooth, đèn LED và hẹn giờ." },
        { icon: "🤝", title: "Đại lý và showroom", desc: "Gói B2B có catalogue, video demo, training tư vấn và hỗ trợ lead." },
      ],
    },
    technology: {
      ...
      subtitle: { text: "Một chiếc giường công thái học cần thuyết phục bằng kết cấu, motor, độ êm, preset và khả năng điều khiển.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "⚙️", title: "Motor nâng hạ êm ái", desc: "Truyền thông về độ ổn định, độ ồn thấp và cảm giác vận hành mượt." },
        { icon: "🧱", title: "Khung và cơ cấu chịu lực", desc: "Giải thích vật liệu khung, tải trọng khuyến nghị và kiểm tra an toàn." },
        { icon: "🎛️", title: "Preset một chạm", desc: "Ngủ, đọc sách, xem TV, chống ngáy, nâng chân và Zero Gravity." },
        { icon: "📲", title: "Remote, app và tiện ích", desc: "Điều khiển thuận tiện cho nhiều độ tuổi, mở rộng sang app và hẹn giờ." },
      ],
    },
    postures: {
      ...
      subtitle: { text: "Dùng ngôn ngữ an toàn: hỗ trợ tư thế, tạo cảm giác thoải mái và thư giãn; không tuyên bố điều trị bệnh.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "🌌", title: "Zero Gravity", desc: "Gợi ý cho người muốn thư giãn toàn thân sau ngày làm việc dài." },
        { icon: "📖", title: "Đọc sách/xem TV", desc: "Giúp cổ và lưng ở tư thế ổn định hơn khi sinh hoạt trên giường." },
        { icon: "🫁", title: "Nâng đầu nhẹ", desc: "Phù hợp người không thoải mái khi nằm phẳng." },
        { icon: "🦵", title: "Nâng chân", desc: "Tạo cảm giác thư giãn chân sau một ngày vận động nhiều." },
        { icon: "🪑", title: "Hỗ trợ ngồi dậy", desc: "Giúp người lớn tuổi chuyển đổi tư thế thuận tiện hơn." },
      ],
    },
    comparison: {
      ...
      subtitle: { text: "Giúp khách hiểu SmartFurni khác giường thường, sofa giường và giường y tế ở thẩm mỹ, tư thế và trải nghiệm sinh hoạt.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
    ...
    trust: {
      ...
      subtitle: { text: "Sản phẩm cơ điện giá trị cao cần thông tin kỹ thuật, bảo hành rõ ràng, showroom và khách hàng thật.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "🧪", title: "Thông số và kiểm tra kỹ thuật", desc: "Công khai tải trọng, góc nâng, độ ồn, bảo hành motor và quy trình QC nếu có dữ liệu xác nhận." },
        { icon: "🏬", title: "Trải nghiệm showroom", desc: "Khuyến khích đặt lịch trải nghiệm để tự cảm nhận độ êm, chất liệu và tư thế." },
        { icon: "🎥", title: "Video review tại nhà", desc: "Tăng độ tin cậy bằng video giao lắp thực tế và khách hàng thật." },
      ],
    },
    process: {
      ...
      subtitle: { text: "Khách hàng biết rõ từng bước: tư vấn, trải nghiệm, cá nhân hóa, giao lắp, hướng dẫn và bảo hành.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "1", title: "Tư vấn nhu cầu", desc: "Xác định mua cho ai, diện tích phòng và thói quen sử dụng." },
        { icon: "2", title: "Trải nghiệm/demo", desc: "Đặt lịch showroom hoặc nhận demo video để hiểu rõ tư thế." },
        { icon: "3", title: "Chọn mẫu", desc: "Chọn kích thước, chất liệu, màu sắc, tính năng và thanh toán." },
        { icon: "4", title: "Giao lắp tận nơi", desc: "Lắp đặt, kiểm tra vận hành và hướng dẫn remote/app." },
        { icon: "5", title: "Bảo hành", desc: "Kích hoạt bảo hành, lưu hotline/Zalo và hỗ trợ kỹ thuật." },
      ],
    },
    b2b: {
      ...
      subtitle: { text: "Chuyển đổi nhóm showroom nệm, đại lý nội thất, kiến trúc sư và đơn vị thiết kế căn hộ mẫu.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "📘", title: "Catalogue và tư liệu", desc: "Hình ảnh, video demo, bảng thông số, kịch bản tư vấn và tài liệu đào tạo." },
        { icon: "🏷️", title: "Chính sách đại lý", desc: "Chiết khấu, khu vực phân phối, điều kiện trưng bày và tiếp nhận lead." },
        { icon: "🛠️", title: "Hỗ trợ kỹ thuật", desc: "Đào tạo lắp đặt, xử lý sự cố, bảo hành motor/khung và linh kiện." },
        { icon: "📣", title: "Hỗ trợ marketing", desc: "Landing page riêng, tracking lead, nội dung quảng cáo địa phương và POSM." },
      ],
    },
    faq: {
      ...
      subtitle: { text: "Giảm băn khoăn về độ bền, giao lắp, bảo hành, nệm tương thích và chi phí trước khi khách liên hệ.", fontSize: 14, color: "#F5EDD6", fontWeight: "normal" },
      items: [
        { icon: "?", title: "Giường điện có bền không?", desc: "Nên trả lời bằng thông tin motor, khung, tải trọng, kiểm tra và thời hạn bảo hành." },
        { icon: "?", title: "Mất điện có dùng được không?", desc: "Giải thích cơ chế đưa giường về vị trí an toàn hoặc pin dự phòng nếu mẫu có hỗ trợ." },
        { icon: "?", title: "Có dùng với nệm hiện tại không?", desc: "Tư vấn theo loại nệm, độ dày, độ đàn hồi và kích thước khung." },
        { icon: "?", title: "Có giao lắp toàn quốc không?", desc: "Nêu khu vực phục vụ, thời gian dự kiến, phí vận chuyển và quy trình kỹ thuật." },
        { icon: "?", title: "Có phù hợp cho người lớn tuổi không?", desc: "Nhấn mạnh tư thế hỗ trợ ngồi dậy, remote dễ dùng và hỗ trợ sau bán hàng." },
        { icon: "?", title: "Có trả góp hoặc đặt riêng không?", desc: "Tăng chuyển đổi cho sản phẩm giá trị cao và nhu cầu cá nhân hóa." },
      ],
    },
  },
